...
/** @type {string} */
const CACHE_VERSION = '1750089990|5677422912';
/** @type {string} */
const CACHE_PREFIX = 'Maze Game-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'mazegame.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["mazegame.html","mazegame.js","mazegame.offline.html","mazegame.icon.png","mazegame.apple-touch-icon.png","mazegame.audio.worklet.js","mazegame.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["mazegame.wasm","mazegame.pck"];
