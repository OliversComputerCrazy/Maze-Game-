...
/** @type {string} */
const CACHE_VERSION = '1748022889|1911119532';
/** @type {string} */
const CACHE_PREFIX = 'Maze Game-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Maze Game.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Maze Game.html","Maze Game.js","Maze Game.offline.html","Maze Game.icon.png","Maze Game.apple-touch-icon.png","Maze Game.audio.worklet.js","Maze Game.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Maze Game.wasm","Maze Game.pck"];
